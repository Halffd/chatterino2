    ...
    {HotkeyCategory::Split,
     {
         ...
         {"disableCommands", ActionDefinition{"Toggle commands"}},
         {"turnOnCommands", ActionDefinition{"Turn On Commands"}},
         {"turnOffCommands", ActionDefinition{"Turn Off Commands"}},
         {"openInStreamlinkOther", ActionDefinition{"Streamlink other"}},
